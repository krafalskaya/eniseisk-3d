...
const infoTexts = {
  ...
  "Bogoyavlenskiy": "Один из крупнейших и красивейших храмов города, построенный в начале XIX века - Собор Богоявления Господня. Его белокаменное здание украшено колоннами и пилястрами. Собор играл важную роль в религиозной и культурной жизни Енисейска.",
  "Iverskiy": "Иверский Монастырь был основан в XIX веке как обитель для женщин, выбравших путь служения Богу. Здесь находилась церковь и жилые корпуса. Здание отличается спокойной, уравновешенной архитектурой.",
  "Voskresenskaya": "Церковь Воскресения Христова занимает особое место в архитектурном ансамбле города. Её постройка связана с возрождением религиозной жизни в Енисейске в XVIII веке. Здание сочетает строгость форм с выразительными деталями.",

  "GymnasiumMale": "Одна из первых учебных организаций города, открытая в XIX веке. Здесь обучались юноши по классической программе, включающей латынь, математику и историю. Здание мужской гимназии выполнено в стиле классицизма.",
  "GymnasiumFem": "Эта гимназия давала образование девушкам из состоятельных семей. Учебная программа включала языки, музыку, рукоделие и основы наук. Здание отличается аккуратной симметричной архитектурой.",
