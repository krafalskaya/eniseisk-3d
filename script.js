...
window.onload = () => {
const infoTexts = {
  "Spasskiy": "<b>Собор Преображения Господня</b> - это главный храм Спасо-Преображенского монастыря — первого мужского монастыря в Сибири. Построенный в XVIII веке, он стал образцом сибирского барокко. Его строгий и величественный облик подчёркивает важность монастыря в духовной жизни города.",
  "Zakhariy": "Небольшая каменная церковь, построенная в конце XVIII века - <b>Церковь Захарии и Елисаветы</b>. Здание отличается гармоничными пропорциями и архитектурной сдержанностью.",
  "Uspenskiy": "Один из старейших храмов Енисейска, построенный в стиле сибирского барокко - <b>Собор Успения Пресвятой Богородицы</b>. Его главный престол освящён в честь Успения Богородицы. В архитектуре сочетаются пышность декора и строгость форм.",
  "Troytskaya": "<b>Церковь Троицы Живоначальной</b> была частью Троицкого прихода, важного для жителей города. Её внешний вид отражает черты народного зодчества и сибирской каменной архитектуры.",
  "Bogoyavlenskiy": "Один из крупнейших и красивейших храмов города, построенный в начале XIX века - <b>Собор Богоявления Господня</b>. Его белокаменное здание украшено колоннами и пилястрами. Собор играл важную роль в религиозной и культурной жизни Енисейска.",
  "Iverskiy": "<b>Иверский Монастырь</b> был основан в XIX веке как обитель для женщин, выбравших путь служения Богу. Здесь находилась церковь и жилые корпуса. Здание отличается спокойной, уравновешенной архитектурой.",
  "Voskresenskaya": "<b>Церковь Воскресения Христова</b> занимает особое место в архитектурном ансамбле города. Её постройка связана с возрождением религиозной жизни в Енисейске в XVIII веке. Здание сочетает строгость форм с выразительными деталями.",

  "GymnasiumMale": "Одна из первых учебных организаций города, открытая в XIX веке. Здесь обучались юноши по классической программе, включающей латынь, математику и историю. Здание <b>мужской гимназии</b> выполнено в стиле классицизма.",
  "GymnasiumFem": "<b>Женская гимназия</b> давала образование девушкам из состоятельных семей. Учебная программа включала языки, музыку, рукоделие и основы наук. Здание отличается аккуратной симметричной архитектурой.",
  "Typography": "В этом здании располагалась <b>типография</b>, где печатали книги и газеты для Енисейска и всей губернии. Типография сыграла важную роль в просвещении и распространении знаний. Архитектура здания проста и функциональна.",
  "Khamitkov": "<b>Дом купца Хамиткова</b> — яркий пример городской усадьбы XIX века. Здесь жили и вели хозяйство представители состоятельного сословия. Здание украшено деревянной резьбой и сохранило элементы первоначального декора.",
  "Urushev": "Каменный <b>дом</b>, принадлежавший купеческой семье <b>Урушевых</b>. Построенный в XIX веке, он служил и жилым помещением, и торговым местом. Фасад здания украшен элементами кирпичной архитектуры.",
  "Borodkin": "<b>Усадьба купца Бородкина</b> — характерный пример купеческой застройки Енисейска. Дом сочетает жилые и хозяйственные функции. Его архитектура отражает вкусы зажиточных горожан XIX века.",
  "Vostrotin": "Этот дом принадлежал известному горожанину <b>Востротину</b>. Здание интересно тем, как сочетаются жилые и складские функции. Оно хорошо передаёт атмосферу деловой части Енисейска XIX века.",
  "Voyevoda": "Один из самых старых домов города, где жил и работал царский представитель — <b>воевода</b>. Здание выполнено из дерева и относится к раннему этапу застройки Енисейска. Оно имеет большое историческое значение.",
  "KytmanovMuseum": "Ранее — <b>усадьба купца Кытманова</b>, а теперь — главный музей города. Здесь собраны предметы быта, документы, картины, рассказывающие об истории Енисейска. Архитектура здания сочетает черты классицизма и сибирского купеческого дома."
};
...
if (isMobile()) {
  ...
  camera.position.set(-20, 40, 15); // Пример: смещаем вниз (меньше по Y) и дальше (больше по Z)
} else {
